...
'''
  ...
  /Name_Dataset/Face_crop_Train_Test/train/Krishna/Krishna_1.jpg
  /Name_Dataset/Face_crop_Train_Test/train/Rahul/Rahul_1.jpg

  /Name_Dataset/Face_crop_Train_Test/test/Krishna/Krishna_1.jpg
  /Name_Dataset/Face_crop_Train_Test/test/Rahul/Rahul_1.jpg
...
bagging_classifier = BaggingClassifier(base_estimator=svc, n_estimators=21)
...
testing_label, label_predicted
skplt.metrics.plot_confusion_matrix(testing_label, label_predicted, normalize=True)
plot.show()
