...
#Adaboost Classifier with SVC as the base learner.
svc = SVC(probability=True, kernel="linear")
ADBclassifier = AdaBoostClassifier(n_estimators=21, base_estimator=svc, learning_rate=0.5, algorithm='SAMME.R')
